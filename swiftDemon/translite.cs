...
namespace transliter_RUENGRU
{
    ...
    {
        static Dictionary<int, string> ru = new Dictionary<int, string>(); /*key - код кириллицы, value - транслит англ.симв.*/
        static Dictionary<int, string> eng = new Dictionary<int, string>(); /*key - код англ.симв., value - транслит кириллицы*/ 
